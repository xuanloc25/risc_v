...
- **Nội dung:** Base `0xFF200000`, range `0x100`; TX/RX FIFO, loopback, ID chuẩn/mở rộng; register map và giới hạn frame/message-level.
...
- **Nội dung:** Bổ sung CSR/privileged, FCSR/làm tròn động, thực thi FENCE; mở rộng TileLink B/C/E + coherence; arbitration đa master thực sự; interrupt controller + IRQ (UART/CAN/DMA/keyboard); mở rộng CAN theo hướng nhiều nút/mô hình lỗi chi tiết; benchmark định lượng; bài lab giảng dạy.
